            ...
            while (true)
            {
                ...
                try
                {
                  ...
                  if (!adduptrrigersignalstomarknumberstaus)         
                  {
                    ...
                    else //down
                    {
                        ...
                        {
                            adduptrrigersignalstomarknumber++;
                ...
                {                 
                        ...
                        else
                        {
                                ...
                                log.WriteLog("no data in the buffer ", textBoxlog);
                                MarkJcz.WritePort(5, true);
                                while (true)
                                {
                                    Thread.Sleep(10);
                                ...
                                log.WriteLog("have " + printstring.Count.ToString() + "   data in the buffer ", textBoxlog);
                                MarkJcz.WritePort(5, false);
                            }
                            ...
                            for (int q = a + 3; q < getbytefromlist.Length - 2; q++)
                            {
                                if (getbytefromlist[q] == 0x1b && getbytefromlist[q + 1] == 0x03 && getbytefromlist[q + 2] == 0x0a)//find end  code 
                                {
                                    ...
                                    lock (lockprintstring)
                                    {
                                        ...
                                        {
                                            log.WriteLog(gettxt+"  can not added to the list,as the list count is more than :" + textBoxdatanumberallow.Text, textBoxlog);
                                        }
                                        else
                                        {
