...
namespace MSICS
{
    ...
    public class MSI
    {
        ...
        public static int Initialize()
        {
            try
            {
               ...
               string str = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles);
                ...
                //HG_LOG.WriteLog.ShowMessageToList("初始化1:" + str, true);
                iR = NativeMethods.ELM_LoadSystemSettingXmlFile(0, 0, str);

                //HG_LOG.WriteLog.ShowMessageToList("初始化2:" + iR, true);
                if (iR < 0)
                {
                    return iR;
                }
          ...
          //
              //  m_bCardOK = true;
                ...
                //m_iCrossMks = NativeMethods.ELM_OpenMksFile(m_strCrossMksPath);
                //if (m_iCrossMks < 0)
                //{
                //    return MSI_ERR_CROSS_MKS;
                //}

                //m_iNPCalibMks = NativeMethods.ELM_OpenMksFile(m_strCrossNpcPath);
                //if (m_iCrossMks < 0)
                //{
                //    return MSI_ERR_NPCALIB_MKS;
                //}
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString());
                return MSI_ERR_NOT_INIT;
            }
        ...
        public static void UnInitialize()
        {
            ...
            //if (m_iCrossMks >= 0)
            //{
            //    NativeMethods.ELM_CloseMksFile(m_iCrossMks);
            //}
        }

        //public static int MarkCrossMks()
        //{
        //    if (m_iCrossMks >= 0)
        //    {
        //        return NativeMethods.ELM_MarkMksFile(0, m_iCrossMks, 0);
        //    }
        //    else
        //        return MSI_ERR_CROSS_MKS;
        //}
        //public static int MarkNPCalibMks()
        //{
        //    if (m_iCrossMks >= 0)
        //    {
        //        return NativeMethods.ELM_MarkMksFile(0, m_iNPCalibMks, 0);
        //    }
        //    else
        //        return MSI_ERR_NPCALIB_MKS;
        //}

        //public static int OpenMksFile(string str)
        //{
        //    return 0;
        //}
        //public static int MarkMksFile(int iFile)
        //{
        //    return 0;
        //}
        ...
        public static bool DrawMksFile(int iDocIndex, IntPtr HWnd)
        {
            NativeMethods.ELM_DrawMksFile(iDocIndex, HWnd);
            return true;
        }
