...
namespace HG.MyJCZ
{
    ...
    public class LoadDll
    {
        ...
        protected static extern LmcErrCode LMC1_MARKENTITY(string EntityName);
        //
        // 出光
        ...
        //[DllImport("MarkEzd.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl, EntryPoint = "lmc1_AxisMoveTo")]
        //protected static extern LmcErrCode lmc1_AxisMoveTo(int axis, double GoalPos);
        //[DllImport("lib.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl, EntryPoint = "lmc1_AxisMoveTo")]
        //protected static extern LmcErrCode lmc1_AxisMoveTo(int axis, double GoalPos);
        [DllImport("MarkEzd.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl, EntryPoint = "lmc1_Reset")]
        protected static extern LmcErrCode lmc1_Reset(bool b0, bool b1);
        ...
        protected static extern LmcErrCode lmc1_AxisCorrectOrigin(int axis);
        ...
        protected static extern int lmc1_GetAxisCoorPulse(int axis);

        [DllImport("MarkEzd.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl, EntryPoint = "lmc1_AxisMoveToPulse")]
        protected static extern int lmc1_AxisMoveToPulse(int axis, int nGaolPos);
