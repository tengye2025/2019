...
namespace FtpClass
{
    ...
    {
        //基本设置
        static private string path = @"ftp://" + "192.168.10.29:2121" + "//";    //目标路径
        static private string ftpip = "192.168.10.29";    //ftp IP地址
        static private string username = "tengye";   //ftp用户名
        static private string password = "112358";   //ftp密码

        public static void FtpHelperSet(string pathadmin, string ftpipadmin, string usernameadmin, string passwordamdin)
        {
            path = pathadmin;//@"ftp://" + "192.168.10.29:2121" + "//";    //目标路径
            ftpip = ftpipadmin;// "192.168.10.29";    //ftp IP地址
            username = usernameadmin;// "tengye";   //ftp用户名
            password = passwordamdin;// "112358";   //ftp密码
        }
        //获取ftp上面的文件和文件夹
