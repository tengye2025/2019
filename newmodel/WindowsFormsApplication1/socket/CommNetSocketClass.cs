...
namespace CommNetSocketClass
{
    ...
    public class MyServer 
    {
        ...
        private  List<NetWorkStreamST> networkstreamlist = new List<NetWorkStreamST>();
        ...
        public  void Write(string ip, ref byte[] buffer)
        {
        ...
        private void RecFromServer(object p)
        {
            while (true)
            {
                ...
                else if (readresult == -1 || readresult == -2)
                {
                    ...
                    string strerrstr = "ClientCannotConnecttoserver";
                    string strerrinfo = " ";
